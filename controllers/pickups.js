...
pickupRouter.post('/', async (req, res) => {
    ...
    try{
        ...
        const {pedido, cliente, fecha, hora, destino, total, formaPago, estado, referencia, bolivares} = req.body;
        ...
        if(!pedido || !cliente || !fecha || !hora || !destino || !total || !formaPago || !estado){
            ...
            async function main() {
                ...
                html: `<p><b>Muchas gracias ${usuario.name} por elegir nuestros servicios!</b>
                    ...
                    <br>
                    <a href="${website_url}/api/pickups/data/${code}" target="_blank">Mira tu código QR aquí</a>
                    <br>
                    <br>
