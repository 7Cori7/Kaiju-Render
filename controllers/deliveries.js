...
deliveryRouter.post('/', async (req, res) => {
    ...
    try{
        ...
        const {pedido, cliente, telefono, destino, total, formaPago, estado} = req.body;
        ...
        if(!pedido || !cliente || !telefono || !destino || !total || !formaPago || !estado){
            ...
            async function main() {
                ...
                html: `<p><b>Muchas gracias ${usuario.name} por elegir nuestros servicios!</b>
                    ...
                    <br>
                    <a href="http://localhost:4000/api/deliveries/data/${code}" target="_blank">Mira tu código QR aquí</a>
                    <br>
                    <br>
